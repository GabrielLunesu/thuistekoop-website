        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="w-1/2 xl:w-1/3">
            <ul className="hidden xl:flex xl:justify-center">
              <li className="mr-12">
                <Link href="/" className="text-coolGray-500 hover:text-coolGray-900 font-medium">Home</Link>
              </li>
              <li className="mr-12">
                <Link href="/aanbod" className="text-coolGray-500 hover:text-coolGray-900 font-medium">Aanbod</Link>
              </li>
              <li className="mr-12">
                <Link href="/over-ons" className="text-coolGray-500 hover:text-coolGray-900 font-medium">Over ons</Link>
              </li>
              <li className="mr-12">
                <Link href="/contact" className="text-coolGray-500 hover:text-coolGray-900 font-medium">Contact</Link>
              </li>
             
            </ul>
          </div>
          <div className="w-1/2 xl:w-1/3">
            <div className="hidden xl:flex items-center justify-end"><a className="inline-block py-2 px-4 mr-2 leading-5 text-coolGray-500 hover:text-coolGray-900 bg-transparent font-medium rounded-md" href="#">Log In</a><a className="inline-block py-2 px-4 text-sm leading-5 text-green-50 bg-navy hover:bg-navy font-medium focus:ring-2 focus:ring-navy focus:ring-opacity-50 rounded-md" href="#">Registreer</a></div>
          </div>
        </div>
          ...
          <nav className="relative p-6 h-full overflow-y-auto">
            <div className="flex flex-col justify-between h-full">
              ...
              <div className="flex flex-wrap">
                ...
                <div className="w-full"><a className="inline-block py-2 px-4 w-full text-sm leading-5 text-white font-medium text-center focus:ring-2 focus:ring-navy focus:ring-opacity-50 rounded-md" href="#">Registreer</a></div>
              </div>
            </div>
          </nav>
